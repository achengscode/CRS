...

{
    ...
    private void AddAction() {
        ...
        try {
            ...
            autoKey = Query.insert("INSERT INTO `customer`(`custUsername`, `phoneNo`, `custPassword`, `salt`, `driverLicenseNo`, `custFname`, `custLname`)"
                    + "VALUES ('"
                    + custUN
                    + "','"
                    + custPh
                    ...
                    + custDL
                    + "','"
                    + custFN + "' ,'" + custLN + "')", autoKey);

            String query = String.format("INSERT INTO custAddress VALUES('%s', '%s', '%s', '%s', '%s')", autoKey, custStreetAddress.getText(),
